...
local module = LUI:GetModule("Colors")
...
local POWER_TYPE_COMBO_POINTS = COMBAT_TEXT_SHOW_COMBO_POINTS_TEXT
...
Colors.Class.args = {
    ...
    --Note: Blizzard seems to be shifting toward using POWER_T
