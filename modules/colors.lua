...
function module:LoadOptions()
	...
	local options = {
			...
			Class = module:NewGroup(L["Colors_Classes"], 3, nil, nil, {
				...
				MANA = module:NewColor(MANA, nil, 22),
				RAGE = module:NewColor(RAGE, nil, 23),
				FOCUS = module:NewColor(FOCUS, nil, 24),
				ENERGY = module:NewColor(ENERGY, nil, 25),
				RUNIC_POWER = module:NewColor(RUNIC_POWER, nil, 26),
				FURY = module:NewColor(FURY, nil, 27),
				INSANITY = module:NewColor(INSANITY, nil, 28),
				MAELSTROM = module:NewColor(MAELSTROM, nil, 29),
				PAIN = module:NewColor(PAIN, nil, 30),
				LUNAR_POWER = module:NewColor(LUNAR_POWER, nil, 31),
				SecondaryHeader = module:NewHeader(L["Color_Secondary"], 40),
				COMBO_POINTS = module:NewColor(COMBO_POINTS, nil, 41),
				ARCANE_CHARGES = module:NewColor(ARCANE_CHARGES, nil, 42),
				HOLY_POWER = module:NewColor(HOLY_POWER, nil, 43),
				SOUL_SHARDS = module:NewColor(SOUL_SHARDS, nil, 44),
				CHI = module:NewColor(CHI, nil, 45),
			}),
