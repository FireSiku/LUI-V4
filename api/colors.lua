...
function module:LoadOptions()
	...
	local options = {
			...
			Factions = module:NewGroup(L["Colors_Factions"], 4, nil, nil, {
				...
				Standing1 = module:NewColor(STANDING_HATED,      nil, 5),
				Standing2 = module:NewColor(STANDING_HOSTILE,    nil, 6),
				Standing3 = module:NewColor(STANDING_UNFRIENDLY, nil, 7),
				Standing4 = module:NewColor(STANDING_NEUTRAL,    nil, 8),
				Standing5 = module:NewColor(STANDING_FRIENDLY,   nil, 9),
				Standing6 = module:NewColor(STANDING_HONORED,    nil, 10),
				Standing7 = module:NewColor(STANDING_REVERED,    nil, 11),
				Standing8 = module:NewColor(STANDING_EXALTED,    nil, 12),
			}),
